...
const FILE_BUDGETS = [
  ...
  },
  {
    ...
    measured: 56_467,
    measuredAt: '2026-09-12',
    why: '地図画面の追加チャンク。Leaflet 一式を含む。共有ボタン（plan_map-location-share-url.md C1）もここ',
  },
  {
    key: 'map-css',
...
const COMPOSITE_BUDGETS = [
  ...
  },
  {
    ...
    measured: 1_075_694,
    measuredAt: '2026-09-12',
    why: 'トップから地図へ入るまでの累計（地図タイルを除く）。2026-09-11 の Preview 実測は 1,142,918 B で、C4 の分割後は 1,120,813 B、Markdown 描画器の分離後は 1,075,339 B、共有ボタンの追加後は 1,075,694 B',
  },
]
